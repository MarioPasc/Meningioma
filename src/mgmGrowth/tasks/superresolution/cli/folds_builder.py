...
We will later fit a global linear meta-learner per (spacing,pulse) using only train-fold subjects,
then evaluate on held-out test-fold subjects, consistent with stacked generalization / Super Learner. 
References: Wolpert (1992), van der Laan et al. (2007). 
"""
...
def parse_args() -> argparse.Namespace:
    ...
    """
    python src/mgmGrowth/tasks/superresolution/cli/folds_builder.py \

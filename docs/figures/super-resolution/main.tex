...
\begin{figure}[ht]
  ...
  \vspace{4pt}
  \includegraphics[width=0.55\textwidth]{residual_cbar.png}

  \vspace{2pt}
  \includegraphics[width=0.55\textwidth]{roi_legend_octant.png}
...
\begin{figure}[ht]
  ...
  \begin{tabular}{%
      ...
      % ---------- legend row ----------
      &
      & \smash{\includegraphics[width=0.55\textwidth]{roi_legend.png}} &
      \\                                  % empty BC col
  \end{tabular}
